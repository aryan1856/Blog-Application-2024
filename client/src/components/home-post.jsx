...
const HomePost = ({ post }) => {
    return (
        <div className="bg-gray-100 border-gray-200 shadow md:h-auto h-auto flex flex-wrap justify-center" style={{ height: '450px', borderRadius:'15px'}}>
            <div className="overflow-hidden h-64 w-full md:w-3/4">
                <img className="object-cover w-full h-64 md:h-full transition duration-300 hover:scale-110" src={IF + post.photo} alt="" style={{borderRadius:'5px'}} />
            </div>
            ...
            <div className="pl-3 py-2 w-full md:w-full mx-auto">
                ...
                <div className="container mx-auto px-4">
                    <div className="text-area">
                        <p className="mt-2 text-gray-700 text-center sm:text-sm md:text-base lg:text-lg">
