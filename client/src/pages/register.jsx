...
function Register() {
  ...
  return (
    <div>
     <div className='flex items-center justi px-6 md:px=[200px] py-4'>
      ...
      <div className='flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]'>
        ...
        <h1 className='text-xl font-bold text-left'>
          Create an Account
           ...
           <button onClick={handleRegister} className='w-full pc-4 py-4 text-lg font-bold text-white bg-black rounded-lg hover:bg-gray-500 hover:text-black'>
            Register
           </button>
